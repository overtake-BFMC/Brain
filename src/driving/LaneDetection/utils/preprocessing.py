...
#U OVOM FAJLU SE NALAZE KALIBRACIJA KAMERE + BEV TRANSFORMACIJA


import cv2
import numpy as np
from src.driving.LaneDetection.utils import constants as const
...
def sobelEdgeDetection(img,direction=2):
